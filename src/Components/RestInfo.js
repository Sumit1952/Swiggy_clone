    ...
    <>
      <div className="flex w-full justify-between mb-2 pb-2">
        ...
        <div className="w-[20%] relative h-42">
          ...
          ></img>
          {count === 0 ? (
            <button className="absolute bottom-1 left-20 rounded-xl text-2xl text-green-600 px-6 py-2 shadow-md border border-white bg-white" onClick={()=>handleAdditems()}>
              ADD
            </button>
          ) : (
            <div className=" absolute bottom-1 left-20 flex gap-3 text-4xl text-green-600 px-6 py-2 shadow-md border border-white bg-white rounded-2xl ">
