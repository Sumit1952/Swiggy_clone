    ...
    return (
       <header className="bg-[#ff5200] font-serif">
        ...
        <div className="pt-16 pb-8 relative">
            ...
            <div className="max-w-[70%] container mx-auto flex gap-7 mt-10">
                <input className="bg-white w-[40%] text-xl  px-6 py-4 rounded-2xl" placeholder="Delhi India"></input>
                <input  className="bg-white w-[55%] text-xl  px-6 py-4 rounded-2xl"placeholder="Search for restaurants items and more "></input>
